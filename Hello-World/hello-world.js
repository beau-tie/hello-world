...
(function () {
    ...
    var new_column1 = "<p>Here's a sunset to make you feel better</p>";
    new_column1 += "<img id=sunset src=\"SunSeaSunset.jpg\" alt=\"Sunset\">";
    var new_column2 = "<p>Jump Scares are predictable</p>";
    new_column2 += "<img id=scary src=\"scary.jpg\" alt=\"Scary Person\">";
